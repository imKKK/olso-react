(function($) {
  ...
  let fromDate = $("#datepicker-from").datepicker({
    highlightToday: true,
    autoClose: true
  });
  fromDate = $("#datepicker-from").datepicker("getDate");
  let toDate = $("#datepicker-to").datepicker("getDate");
  ...
  jQuery(document).ready(function($) {
    ...
    //landing main testimonial
    var swiper_2 = new Swiper(".olo-cats-slider", {
      slidesPerView: 3,
      spaceBetween: 30,
      centeredSlides: true,
      slidesPerGroup: 1,
      ...
      navigation: {
        nextEl: ".olo-prev-style2",
        prevEl: ".olo-next-style2"
      },
    ...
    //Trusted by
    var swiper_111 = new Swiper(".olo-trusted", {
      slidesPerView: 5,
      spaceBetween: 30,
      loop: false,
      speed: 1000,
...
(function($) {
  ...
  /*-------------------------------------
        Product Heading (Bold - light)
  -------------------------------------*/
  $(window).scroll(function() {
    //After scrolling 100px from the top...
    if ($(window).scrollTop() >= 100) {
      $(".header-title h1").css("font-size", "20px");
      $(".header-title h1").css("padding-bottom", "5px");
      $(".header-title h1").css("font-weight", "400");

      //Otherwise remove inline styles and thereby revert to original stying
    } else {
      $(".header-title h1").css("font-size", "24px");
      $(".header-title h1").css("padding-bottom", "0px");
      $(".header-title h1").css("font-weight", "600");
    }
  });

  /*-------------------------------------
        Show floating rent now button
     -------------------------------------*/
  //Hide renot now floating button over a division
  $(document).ready(function() {
    $(".fixed-rent-now").hide(); //hide your div initially

    var topOfOthDiv3 = $(".rent-widget").offset().top;

    $(window).scroll(function() {
      if ($(window).scrollTop() > topOfOthDiv3 + 300) {
        //scrolled past the other div?
        $(".fixed-rent-now").fadeIn(1000); //reached the desired point -- show div
      } else if ($(window).scrollTop() < topOfOthDiv3 + 200) {
        //scrolled past the other div?
        $(".fixed-rent-now").fadeOut(200); //reached the desired point -- show div
      }
    });
  });

  /*-------------------------------------
              Scroll to rent widget
     -------------------------------------*/
  $(document).ready(function() {
    $(".fixed-rent-now #rent-now").on("click", function(e) {
      e.preventDefault();
